...
create_user() {
  ...
  $snafu -t vegeta -r vegeta-create_user-performance-${uuid}-result.json -u ${uuid} --target_name ${db}_${URL} -w ${rate}
...
update_password() {
  ...
  $snafu -t vegeta -r vegeta-update_password-performance-${uuid}-result.json -u ${uuid} --target_name ${db}_${URL} -w ${rate}
...
create_team() {
  ...
  $snafu -t vegeta -r vegeta-create_team-performance-${uuid}-result.json -u ${uuid} --target_name ${db}_${URL} -w ${rate}
...
create_repo() {
  ...
  $snafu -t vegeta -r vegeta-create_repo-performance-${uuid}-result.json -u ${uuid} --target_name ${db}_${URL} -w ${rate}
...
add_user_to_team() {
  ...
  $snafu -t vegeta -r vegeta-add_user_to_repo-performance-${uuid}-result.json -u ${uuid} --target_name ${db}_${URL} -w ${rate}
